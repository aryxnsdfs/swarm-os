...
| Resource | Link |
|---|---|
| Hugging Face Space (Live Environment) | [Insert HF Space URL] |
| Presentation Video (2-Min Pitch) | [Insert YouTube URL] |
| Colab Training Script (Reproducible) | [Open in Colab](https://colab.research.google.com/drive/15XLbHBzBZJCZIqS_8PqZDFSuhUmOe1bv?usp=sharing) |
| Manifest File | `openenv.yaml` (Included in Root) |
